...
```{r}
test <- Yearlycumulative_vaccine("Alberta")
```



```{r}
test_that("testing of Yearlycumulative_vaccine", {
  expected <- Yearlycumulative_vaccine("Alberta")
  expect_s3_class(expected, "data.frame")
  expect_equal(unique(expected$province), "Alberta")
  expect_equal(unique(expected$year), "2020")
